...
nc_data <- nc_open('AERDB_M3_VIIRS_SNPP.A2020032.001.2020070000611.nc')
# Save the print(nc) dump to a text file

{
  sink('AERDB_M3_VIIRS_SNPP.A2020032.001.2020070000611.txt')
  print(nc_data)
  sink()
}
  ...
  
{
  ...
  titletext <- "Aerosol_Optical_Thickness_550nm_Land_Ocean_Maximum__ENSEMBLE__ (April,2020)"
