...
nc_data <- nc_open('AERDB_M3_VIIRS_SNPP.A2020061.001.2020099000323.nc')
# Save the print(nc) dump to a text file

{
  sink('AERDB_M3_VIIRS_SNPP.A2020061.001.2020099000323.txt')
  print(nc_data)
  sink()
}
  ...
  
{
  ...
  titletext <- "Aerosol_Optical_Thickness_550nm_Land_Ocean_Maximum__ENSEMBLE__ (February,2020)"
